...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#1e3a8a] to-[#0f172a]">
      <section className="bg-gradient-to-br from-[#1e3a8a] to-[#0f172a] text-white py-16 md:py-20 lg:py-32 px-4 relative overflow-hidden">
        <div className="absolute inset-0">
          <div className="absolute top-20 left-10 w-2 h-2 bg-blue-300 rounded-full animate-pulse animate-float"></div>
          <div
            className="absolute top-40 right-20 w-1 h-1 bg-blue-400 rounded-full animate-pulse animate-heartbeat"
            style={{ animationDelay: "1s" }}
          ></div>
          <div
            className="absolute bottom-32 left-20 w-3 h-3 bg-blue-200 rounded-full animate-pulse animate-wiggle"
            style={{ animationDelay: "2s" }}
          ></div>
          <div
            className="absolute bottom-20 right-10 w-2 h-2 bg-blue-500 rounded-full animate-pulse animate-bounce-slow"
            style={{ animationDelay: "0.5s" }}
          ></div>
          <div
            className="absolute top-1/3 left-1/3 w-1 h-1 bg-blue-600 rounded-full animate-pulse animate-float-reverse"
            style={{ animationDelay: "1.5s" }}
          ></div>
          <div
            className="absolute top-2/3 right-1/3 w-2 h-2 bg-blue-100 rounded-full animate-pulse animate-glow"
            style={{ animationDelay: "2.5s" }}
          ></div>
          <div
            className="absolute top-1/4 right-1/4 w-1 h-1 bg-blue-300 rounded-full animate-pulse animate-float-delayed"
            style={{ animationDelay: "3s" }}
          ></div>
          <div
            className="absolute bottom-1/3 left-1/4 w-2 h-2 bg-blue-50 rounded-full animate-pulse animate-heartbeat"
        ...
        <div className="container mx-auto text-center relative z-10">
          <div className={`mb-6 md:mb-8 transition-all duration-1000 ${isVisible ? "animate-rotate-in" : "opacity-0"}`}>
            <span className="inline-block bg-blue-400/20 border border-blue-400/30 text-blue-200 px-4 md:px-6 py-2 md:py-3 rounded-full text-xs md:text-sm font-medium hover:animate-wiggle">
              ⭐ Experts en Transformation Digitale
            </span>
          </div>

          <h1
            className={`text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold mb-6 md:mb-8 leading-tight transition-all duration-1000 delay-300 ${isVisible ? "animate-slide-in-down" : "opacity-0"}`}
          >
            ...
            <span className="block mt-2 sm:mt-0">
              <span className="text-blue-300 animate-glow">Intégration CRM HubSpot, Data et</span>
            </span>
            <br className="hidden sm:block" />
            <span className="block mt-2 sm:mt-0 text-blue-300 animate-heartbeat">Agents IA</span>
          </h1>

          <p
            className={`text-base sm:text-lg md:text-xl text-blue-100 mb-8 md:mb-10 max-w-xs sm:max-w-2xl md:max-w-3xl mx-auto leading-relaxed px-4 sm:px-0 transition-all duration-1000 delay-500 ${isVisible ? "animate-flip-in" : "opacity-0"}`}
          >
          ...
          >
            ...
            <Button
              variant="outline"
              className="w-full sm:w-auto border-2 border-blue-300 text-blue-300 hover:bg-blue-300 hover:text-[#1e3a8a] px-6 md:px-8 py-3 md:py-4 text-base md:text-lg font-medium rounded-full transition-all duration-300 bg-transparent hover:animate-wiggle touch-manipulation"
            >
          ...
          <div className="mt-12 md:mt-16 flex justify-center">
            <div className="relative">
              <div className="w-48 h-48 sm:w-56 sm:h-56 md:w-64 md:h-64 bg-gradient-to-br from-blue-300/20 to-blue-500/20 rounded-full flex items-center justify-center animate-float animate-glow">
                <div className="text-6xl sm:text-7xl md:text-8xl animate-bounce-slow hover:animate-shake">🚀</div>
              </div>
              <div className="absolute -top-2 sm:-top-4 -right-2 sm:-right-4 w-6 h-6 sm:w-8 sm:h-8 bg-blue-400 rounded-full animate-float-reverse animate-heartbeat"></div>
              <div className="absolute -bottom-2 sm:-bottom-4 -left-2 sm:-left-4 w-4 h-4 sm:w-6 sm:h-6 bg-blue-500 rounded-full animate-float animate-wiggle"></div>
              <div className="absolute top-1/2 -left-8 w-3 h-3 bg-blue-300 rounded-full animate-pulse animate-bounce-slow"></div>
              <div className="absolute top-1/2 -right-8 w-3 h-3 bg-blue-600 rounded-full animate-pulse animate-float-delayed"></div>
            </div>
          </div>
        </div>
      </section>

      <section className="bg-[#f8fafc] py-12 border-t border-blue-200/30">
        <div className="container mx-auto px-4">
          <div className="text-center mb-8">
            <p className="text-[#1e3a8a] text-sm font-medium mb-6 animate-fade-in">Ils nous font confiance</p>
          </div>

          <div className="relative overflow-hidden">
            <div className="flex animate-scroll space-x-12 items-center justify-center">
              <div className="flex items-center justify-center min-w-[120px] h-16 bg-white/80 rounded-lg px-4 backdrop-blur-sm hover:animate-wiggle transition-all duration-300">
                <img
              ...
              <div className="flex items-center justify-center min-w-[120px] h-16 bg-white/80 rounded-lg px-4 backdrop-blur-sm hover:animate-heartbeat transition-all duration-300">
                <span className="text-[#1e3a8a] font-semibold text-lg opacity-70 hover:opacity-100 transition-opacity">
                  Google
                </span>
              </div>
              <div className="flex items-center justify-center min-w-[120px] h-16 bg-white/80 rounded-lg px-4 backdrop-blur-sm hover:animate-bounce-slow transition-all duration-300">
                <span className="text-[#1e3a8a] font-semibold text-lg opacity-70 hover:opacity-100 transition-opacity">
                  Meta
                </span>
              </div>
      ...
      <section className="py-16 md:py-20 lg:py-32 bg-white text-blue-900">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12 md:mb-16 scroll-reveal">
            <div className="text-blue-600 font-semibold mb-3 md:mb-4 uppercase tracking-wide text-sm md:text-base animate-fade-in">
            ...
            <p className="text-blue-700 max-w-xs sm:max-w-2xl md:max-w-3xl mx-auto leading-relaxed text-sm md:text-base px-4 sm:px-0 animate-fade-in-delayed">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
            <div className="text-center group scroll-reveal">
              <div className="w-24 h-24 sm:w-28 sm:h-28 md:w-32 md:h-32 bg-gradient-to-br from-blue-400 to-blue-600 rounded-full flex items-center justify-center mx-auto mb-4 md:mb-6 animate-float group-hover:scale-110 group-hover:animate-heartbeat transition-transform duration-300">
                <div className="text-3xl sm:text-4xl md:text-5xl">🤝</div>
              </div>
              <h3 className="text-xl font-bold mb-3 md:mb-4 animate-slide-up-delayed">Gagnant - Gagnant</h3>
              <p className="text-blue-700 leading-relaxed text-sm md:text-base animate-fade-in-delayed">
                Notre approche collaborative garantit le succès mutuel de nos projets avec des objectifs alignés.
              </p>
            </div>

            <div className="text-center group scroll-reveal">
              <div className="w-24 h-24 sm:w-28 sm:h-28 md:w-32 md:h-32 bg-gradient-to-br from-blue-500 to-blue-700 rounded-full flex items-center justify-center mx-auto mb-4 md:mb-6 animate-float-reverse group-hover:scale-110 group-hover:animate-wiggle transition-transform duration-300">
                <div className="text-3xl sm:text-4xl md:text-5xl">🚀</div>
              </div>
            ...
            <div className="text-center group scroll-reveal">
              <div className="w-24 h-24 sm:w-28 sm:h-28 md:w-32 md:h-32 bg-gradient-to-br from-blue-600 to-blue-800 rounded-full flex items-center justify-center mx-auto mb-4 md:mb-6 animate-float group-hover:scale-110 group-hover:animate-bounce-slow transition-transform duration-300">
                <div className="text-3xl sm:text-4xl md:text-5xl">⚡</div>
              </div>
          ...
          <div className="text-center mt-8 md:mt-12 scroll-reveal">
            <Button className="bg-blue-600 hover:bg-blue-700 text-white px-6 md:px-8 py-2 md:py-3 rounded-full hover:animate-heartbeat transition-all duration-300">
              Découvrir plus →
            </Button>
          </div>
        </div>
      ...
      <section className="py-16 md:py-20 lg:py-32 bg-[#f8fafc] text-[#1e3a8a]">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12 md:mb-16">
            ...
            <p className="text-[#64748b] max-w-xs sm:max-w-2xl md:max-w-3xl mx-auto leading-relaxed text-sm md:text-base px-4 sm:px-0">
              Comme nous, de la conquête de nouveaux clients, nous vous accompagnons notre accompagnement en fonction de
              vos enjeux et objectifs.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
            <div className="text-center group">
              <div className="w-24 h-24 sm:w-28 sm:h-28 md:w-32 md:h-32 bg-gradient-to-br from-orange-400 to-orange-600 rounded-full flex items-center justify-center mx-auto mb-4 md:mb-6 animate-float group-hover:scale-110 transition-transform duration-300">
                <div className="text-3xl sm:text-4xl md:text-5xl">🤝</div>
              </div>
            ...
            <div className="text-center group">
              <div className="w-24 h-24 sm:w-28 sm:h-28 md:w-32 md:h-32 bg-gradient-to-br from-blue-400 to-blue-600 rounded-full flex items-center justify-center mx-auto mb-4 md:mb-6 animate-float-reverse group-hover:scale-110 transition-transform duration-300">
                <div className="text-3xl sm:text-4xl md:text-5xl">🚀</div>
              </div>
            ...
            <div className="text-center group">
              <div className="w-24 h-24 sm:w-28 sm:h-28 md:w-32 md:h-32 bg-gradient-to-br from-blue-300 to-blue-500 rounded-full flex items-center justify-center mx-auto mb-4 md:mb-6 animate-float group-hover:scale-110 transition-transform duration-300">
                <div className="text-3xl sm:text-4xl md:text-5xl">⚡</div>
              </div>
          ...
          <div className="text-center mt-8 md:mt-12">
            <Button className="bg-[#1e3a8a] hover:bg-[#1e40af] text-white px-6 md:px-8 py-2 md:py-3 rounded-full">
              Découvrir plus →
            </Button>
          </div>
        </div>
      ...
      <section id="services-section" className="py-20 md:py-32 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16 md:mb-20">
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-[#1e3a8a] mb-4 md:mb-6 px-4 sm:px-0">
              Nos <span className="text-orange-500">Services</span>
            </h2>
            <p className="text-lg md:text-xl text-[#64748b] max-w-xs sm:max-w-3xl md:max-w-4xl mx-auto leading-relaxed px-4 sm:px-0">
                ...
                <CardContent className="p-6 md:p-8">
                  ...
                  {service.external ? (
                    <a href={service.link} target="_blank" rel="noopener noreferrer">
                      <Button className="w-full bg-[#1e3a8a] hover:bg-[#1e40af] text-white py-2 md:py-3 text-base font-semibold shadow-md hover:shadow-lg transition-all duration-200 touch-manipulation">
                        En savoir plus →
                      </Button>
                    </a>
                  ) : (
      ...
      <section className="py-12 md:py-20 bg-gradient-to-br from-[#1e3a8a] to-[#0f172a] text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="scroll-reveal text-2xl sm:text-3xl md:text-4xl font-bold mb-4 md:mb-4 px-4 sm:px-0">
            Prêt à décoller ?
          </h2>
          <p className="scroll-reveal text-base md:text-xl text-blue-100 mb-6 md:mb-8 max-w-xs sm:max-w-2xl md:max-w-2xl mx-auto leading-relaxed px-4 sm:px-0">
      ...
      <section className="py-16 bg-[#f8fafc]">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="scroll-reveal text-2xl sm:text-3xl md:text-4xl font-bold text-[#1e3a8a] mb-4 md:mb-4 px-4 sm:px-0">
              Nos <span className="text-orange-500">Partenaires</span>
            </h2>
            <p className="scroll-reveal text-lg text-[#64748b] max-w-xs sm:max-w-3xl md:max-w-3xl mx-auto leading-relaxed px-4 sm:px-0">
          ...
          <div className="flex flex-wrap justify-center items-center gap-8 md:gap-12">
            <div className="scroll-reveal bg-white/80 backdrop-blur-sm border border-blue-200 p-6 rounded-xl hover-lift transition-all duration-300">
              <div className="flex items-center space-x-4">
                <div className="w-16 h-16 bg-orange-100 rounded-lg flex items-center justify-center">
                  <img src="/hubspot-logo.png" alt="HubSpot" className="w-12 h-12 object-contain" />
                </div>
                <div>
                  <h3 className="text-lg font-bold text-[#1e3a8a]">HubSpot</h3>
                  <p className="text-sm text-[#64748b]">Partenaire CRM & Marketing</p>
                </div>
              </div>
            </div>
            ...
            <div className="scroll-reveal bg-white/80 backdrop-blur-sm border border-blue-200 p-6 rounded-xl hover-lift transition-all duration-300">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <h3 className="text-lg font-bold text-[#1e3a8a]">Odoo</h3>
                  <p className="text-sm text-[#64748b]">Partenaire ERP & CRM</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section id="contact-section" className="py-12 md:py-20 bg-[#f8fafc]">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12">
            <div>
              <h2 className="text-2xl md:text-3xl font-bold text-[#1e3a8a] mb-6 md:mb-8">Discutons de votre projet</h2>
              <form action="https://formspree.io/f/xkgvdzkd" method="POST" className="space-y-4 md:space-y-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-sm font-medium text-[#1e3a8a] mb-2">Prénom</label>
                    <Input name="prenom" placeholder="Votre prénom" required className="touch-manipulation" />
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-[#1e3a8a] mb-2">Nom</label>
                ...
                <div>
                  <label className="block text-sm font-medium text-[#1e3a8a] mb-2">Entreprise</label>
            ...
            <div className="space-y-6 md:space-y-8">
              <div>
                <h3 className="text-xl font-bold text-[#1e3a8a] mb-4">Email</h3>
                <p className="text-[#64748b]">contact@nolia.fr</p>
                <p className="text-[#64748b]">hello@nolia.fr</p>
              </div>

              <div>
                <h3 className="text-xl font-bold text-[#1e3a8a] mb-4">Téléphone</h3>
                <p className="text-[#64748b]">+33 1 23 45 67 89</p>
                <p className="text-[#64748b]">Lun - Ven : 9h - 18h</p>
              </div>

              <div>
                <h3 className="text-xl font-bold text-[#1e3a8a] mb-4">Adresse</h3>
                <p className="text-[#64748b]">123 Avenue de l'Innovation</p>
                <p className="text-[#64748b]">75000 Paris, France</p>
              </div>
            </div>
          </div>
        </div>
