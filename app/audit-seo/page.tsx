              ...
              {isSubmitted ? (
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-600 mb-6">
                    Votre demande d'audit SEO a été transmise. Nous vous contacterons sous 48h avec votre audit
                    personnalisé.
                  </p>
                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                  <input type="hidden" name="_to" value="najwaborak01@gmail.com" />
                  <input type="hidden" name="_subject" value="🔍 Nouvelle demande d'audit SEO gratuit - NOLIA" />
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="delai-souhaite">
                        Dans quel délai souhaitez-vous voir les premiers résultats ?
                      </Label>
                  ...
                  <div className="pt-6">
                    ...
                    >
                      {isSubmitting ? "Envoi en cours..." : "Demander mon audit SEO gratuit"}
                    </Button>
                  </div>
                </form>
              )}
