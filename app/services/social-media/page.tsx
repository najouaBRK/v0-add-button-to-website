...
export default function SocialMediaPage() {
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <section className="bg-gradient-to-br from-pink-900 via-pink-800 to-pink-700 text-white py-20 px-4">
        <div className="container mx-auto text-center">
          ...
          <h1 className="text-5xl md:text-6xl font-bold mb-8 leading-tight">
            Engagez votre <span className="text-orange-400">communauté</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button
              variant="outline"
              className="border-white text-white hover:bg-white hover:text-pink-900 px-8 py-3 text-lg font-medium bg-transparent"
            >
              Voir nos créations
            </Button>
          </div>
