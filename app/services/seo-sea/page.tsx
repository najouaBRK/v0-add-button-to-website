      ...
      <section className="bg-gradient-to-br from-blue-600 via-blue-500 to-cyan-400 text-white py-16 md:py-20 px-4">
        <div className="container mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center px-4 sm:px-0">
            <Link href="/audit-seo">
              <Button className="w-full sm:w-auto bg-blue-800 hover:bg-blue-900 text-white px-6 md:px-8 py-2 md:py-3 text-base md:text-lg font-medium touch-manipulation">
      ...
      <section className="py-16 md:py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
            <Card className="text-center p-6 md:p-8 border-0 shadow-lg hover:shadow-xl transition-shadow">
              <CardContent className="pt-0">
                ...
                <h3 className="text-lg md:text-xl font-bold text-gray-900 mb-3 md:mb-4">Audit SEO</h3>
            ...
            <Card className="text-center p-6 md:p-8 border-0 shadow-lg hover:shadow-xl transition-shadow">
              <CardContent className="pt-0">
                <div className="w-12 h-12 md:w-16 md:h-16 bg-cyan-100 rounded-full flex items-center justify-center mx-auto mb-4 md:mb-6">
                  <span className="text-cyan-600 text-xl md:text-2xl">📝</span>
                </div>
                <h3 className="text-lg md:text-xl font-bold text-gray-900 mb-3 md:mb-4">Content Marketing</h3>
                <p className="text-gray-600 text-sm md:text-base">
            ...
            <Card className="text-center p-6 md:p-8 border-0 shadow-lg hover:shadow-xl transition-shadow">
              <CardContent className="pt-0">
                <div className="w-12 h-12 md:w-16 md:h-16 bg-blue-200 rounded-full flex items-center justify-center mx-auto mb-4 md:mb-6">
                  <span className="text-blue-700 text-xl md:text-2xl">✍️</span>
                </div>
                <h3 className="text-lg md:text-xl font-bold text-gray-900 mb-3 md:mb-4">Copywriting</h3>
                <p className="text-gray-600 text-sm md:text-base">
            ...
            <Card className="text-center p-6 md:p-8 border-0 shadow-lg hover:shadow-xl transition-shadow">
              <CardContent className="pt-0">
                <div className="w-12 h-12 md:w-16 md:h-16 bg-cyan-200 rounded-full flex items-center justify-center mx-auto mb-4 md:mb-6">
                  <span className="text-cyan-700 text-xl md:text-2xl">🤝</span>
                </div>
                <h3 className="text-lg md:text-xl font-bold text-gray-900 mb-3 md:mb-4">Google Partner</h3>
                <p className="text-gray-600 text-sm md:text-base">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            <div className="text-center">
              ...
              <h3 className="text-lg md:text-xl font-bold text-gray-900 mb-3 md:mb-4">Audit</h3>
              <p className="text-gray-600 text-sm md:text-base">
            ...
            <div className="text-center">
              <div className="w-12 h-12 md:w-16 md:h-16 bg-cyan-500 text-white rounded-full flex items-center justify-center mx-auto mb-4 md:mb-6 text-lg md:text-2xl font-bold">
                4
              </div>
              <h3 className="text-lg md:text-xl font-bold text-gray-900 mb-3 md:mb-4">Accompagnement et recettage</h3>
              <p className="text-gray-600 text-sm md:text-base">
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg md:text-xl font-bold text-gray-900 mb-3 md:mb-4">Définition et suivi des KPIs</h3>
              <p className="text-gray-600 text-sm md:text-base">
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center px-4 sm:px-0">
            ...
            <Link href="/#contact-section">
              <Button
                variant="outline"
                className="w-full sm:w-auto border-white text-white hover:bg-white hover:text-blue-600 px-6 md:px-8 py-2 md:py-3 text-base md:text-lg font-medium bg-transparent touch-manipulation"
              >
                Nous contacter
              </Button>
            </Link>
      ...
      <section className="py-16 md:py-20 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 max-w-6xl mx-auto">
            <Card className="p-6 md:p-8 border-2 border-gray-200 hover:border-blue-500 transition-colors">
              <CardContent className="pt-0">
                <div className="text-center mb-6">
                  <h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-2">Starter</h3>
                  <div className="text-3xl md:text-4xl font-bold text-blue-600 mb-2">1 500€</div>
                  <div className="text-gray-500">par mois</div>
                </div>
                <ul className="space-y-3 text-gray-600 mb-6 md:mb-8 text-sm md:text-base">
                ...
                <div className="text-center">
                  ...
                  >
                    <Button className="w-full bg-blue-600 hover:bg-blue-700 text-white px-4 md:px-6 py-2 md:py-3 text-base md:text-lg font-medium touch-manipulation">
                      Choisir Starter
                    </Button>
                  </a>
                </div>
            ...
            <Card className="p-6 md:p-8 border-2 border-blue-500 bg-blue-50 relative">
              ...
              <CardContent className="pt-0">
                <div className="text-center mb-6">
                  <h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-2">Professional</h3>
          ...
          <div className="text-center mt-8 md:mt-12">
            <p className="text-base md:text-lg text-gray-600 mb-4 md:mb-6 px-4 sm:px-0">
            ...
            >
              <Button className="bg-orange-500 hover:bg-orange-600 text-white px-6 md:px-8 py-2 md:py-3 text-base md:text-lg font-medium touch-manipulation">
                Demander mon devis
              </Button>
            </a>
          </div>
