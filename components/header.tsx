      ...
      <div className="container mx-auto px-4 flex h-16 md:h-20 items-center justify-between">
        ...
        <nav className="hidden md:flex items-center space-x-6 lg:space-x-8">
          ...
          >
            ...
            <div
              className={`fixed top-20 left-1/2 transform -translate-x-1/2 bg-white/95 backdrop-blur-sm border border-gray-200 rounded-lg shadow-2xl p-6 lg:p-8 transition-all duration-300 z-[9999] ${
                isExpertisesOpen
            ...
            >
                    ...
                    <div className="space-y-1 lg:space-y-2">
                      {expertise.categories.map((category, catIndex) => (
                        <Link
                          ...
                          className="block text-gray-700 hover:text-orange-500 transition-all duration-300 text-xs lg:text-sm py-1 px-2 rounded hover:bg-gray-100/50 group"
                        >
              ...
              <div
                className={`mt-6 lg:mt-8 pt-4 lg:pt-6 border-t border-gray-200 text-center transform transition-all duration-700 ${
                  isExpertisesOpen ? "translate-y-0 opacity-100" : "translate-y-4 opacity-0"
                }`}
